  ...
  return (
    <div className="flex lg:flex-row flex-col">
      ...
      <div className="lg:w-[1190px] w-full text-center">
        <p className="text-center text-lg font-medium text-primary p-4 uppercase tracking-widest bg-cyan h-20 mb-5 justify-center items-center" >
          {edit ? "Edit Contact" : "Contact Page"}
        </p>
